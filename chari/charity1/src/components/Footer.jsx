          ...
          <div className="row">
            <div className="col-lg-3 col-md-6">
              <div className="footer-contact">
                ...
                >
                  <p>
                    <i className="fa fa-map-marker-alt"></i>Harar, Ethiopia
                  </p>
                </a>
                <a href="tel:+91-7385223242">
                  <p>
                    <i className="fa fa-phone"></i>+251984600700
                  </p>
                </a>
                <a href="mailto:sanjivani.vitswd@vit.edu">
                  <p>
                    <i className="fa fa-envelope"></i>info@majmuaa.com
                  </p>
                </a>
        ...
        <div className="container copyright">
          <div className="row">
            <div className="col-md-6">
              <p>
                &copy; <a href="#">THE NILE NGO</a> | 2025, All Right
                Reserved.
              </p>
            </div>
            <div className="col-md-6">
